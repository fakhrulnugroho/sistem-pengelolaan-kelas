...
2. Selanjutnya kalian bisa buka file `config.json`
3. Ubah isi dari `BASE_URL` dengan `http://localhost/namafolder/`
4. Untuk `namafolder` silahkan kalian ganti sesuai nama folder dari aplikasi ini di komputer atau laptop kalian
5. Ubah juga `DB_HOST`, `DB_NAME`, `DB_USER`, `DB_PASS` sesuai dengan konfigurasi database kalian
6. Untuk login kalian bisa register terlebih dahulu atau menggunakan username = `admin123` dan password `admin123`
